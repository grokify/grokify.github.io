...
1. [AWS](#aws-6)
    ...
    1. [Introduction to AWS Trusted Advisor from Simplilearn by](#introduction-to-aws-trusted-advisor-from-simplilearn-by)
    1. [Getting Started with AWS Security Hub from Simplilearn by](#getting-started-with-aws-security-hub-from-simplilearn-by)
    1. [Introduction to AWS Security Token Services (STS) from Simplilearn by](#introduction-to-aws-security-token-services-sts-from-simplilearn-by)
...
### Introduction to AWS Trusted Advisor from Simplilearn by 

![John's Introduction to AWS Trusted Advisor from Simplilearn by](cert_aws_intro-to-aws-trusted-advisor_simplilearn_cert-4971787_1710945844_2024-03-20.png)

### Getting Started with AWS Security Hub from Simplilearn by 

![John's Getting Started with AWS Security Hub from Simplilearn by](cert_aws_getting-started-with-aws-security-hub_simplilearn_cert-4973168_1711030705_2024-03-21.png)

### Introduction to AWS Security Token Services (STS) from Simplilearn by 

![John's Introduction to AWS Security Token Services (STS) from Simplilearn by](cert_aws_introduction-to-aws-security-token-services-sts_6733873_2024-06-15.png)
